...
import './App.css';
import history from './global/browser-history';
...
class App extends Component {
  constructor(props){
	...
	componentDidMount = async () => {
		...
		{
			window.ipcRenderer.on('sending', (event, arg) => {
  ...
  render() {
	const { socket, chatGroups, directChats } = this.state
	return (
		...
		<div className="chat-main-row">
		  <div className="chat-main-wrapper">
			...
			{ (socket)? 
			  <Switch>
				<Route exact path="/">
				  <ChatWindow {...this.props} sio={socket}/>
				</Route>
						...
						<div className="chats">
						  ...
						  <div className="chat chat-left">
							<div className="chat-avatar">
							  <Link to="/profile?ref_id=1234" className="avatar">
						...
						<div className="table-body">
						  <div className="table-content">
							<div className="chat-profile-img">
							  ...
							  <h3 className="user-name m-t-10 mb-0"><Link to="/profile">Cristina Groves</Link> </h3>
							  <p className="mb-0"><small className="text-muted">Dept. Gynecology</small></p>
							  <small className="text-muted">Gynecologist</small>
							  <Link to="/update-profile" className="btn btn-primary edit-btn"><i className="fa fa-pencil"></i></Link>
							</div>
